...
namespace SKBKontur.Treller.Tests.Tests.UnitTests.News.Import
{
    public class TextNewParserTest : UnitTest
    {
        ...
        [Theory]
        [InlineData("Просто какой-то текст", false, "")]
        [InlineData(textWithMotivationAndBothNews, true, "Произвели перевод клиентов по продуктам УЦ от обслуживающего сервисного центра к доставляющему. Перевели клиентов, у которых был выставлен счет с 01.10.2015 по 30.06.2016. Цель перевода: поддержание процесса продления клиентов по продуктам УЦ.")]
        [InlineData(textWithMotivationAndLastTechNew, true, "Произвели перевод клиентов по продуктам УЦ от обслуживающего сервисного центра к доставляющему. Перевели клиентов, у которых был выставлен счет с 01.10.2015 по 30.06.2016. Цель перевода: поддержание процесса продления клиентов по продуктам УЦ.")]
        [InlineData(textWithNewLinesAtTechNew, true, "Произвели перевод клиентов по продуктам УЦ от обслуживающего сервисного центра к доставляющему.\nПеревели клиентов, у которых был выставлен счет с 01.10.2015 по 30.06.2016. Цель перевода: поддержание процесса продления клиентов по продуктам УЦ.")]
